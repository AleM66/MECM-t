...
## Fun??es auxiliares para o algoritmo ECM ##

## Momentos da Distribui??o t Truncada ##

## Fun??o de distribui??o acumulada da Normal e da t ##
...
## C?lculo dos dois primeiros momentos quando mu = 0 e usa-se a matriz R (modifica??o da fun??o TT.moment do R) ##
## A fun??o original TT.moment do R calcula os 2 primeiros momentos da t multivariada truncada ##
...
## Calcula os primeiros momentos quando mu n?o ? 0 e sigma n?o ? R ##
